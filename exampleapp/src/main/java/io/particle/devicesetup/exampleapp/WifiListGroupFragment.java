 ...
 */
public class WifiListGroupFragment<T extends WifiNetwork> extends ListFragment
    ...
    private static final TLog log = TLog.get(WifiListGroupFragment.class);
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            if (convertView == null) {
                convertView = LayoutInflater.from(parent.getContext())
                        .inflate(R.layout.row_wifi_scan_group_result, parent, false);
                ...
                ImageView theWifi = Ui.findView(convertView, io.particle.android.sdk.devicesetup.R.id.the_wifi);
                Drawable whiteWifi = Ui.getTintedDrawable(getContext(), io.particle.android.sdk.devicesetup.R.drawable.the_wifi,
                        android.R.color.white);
                theWifi.setImageDrawable(whiteWifi);

                ImageView securityIcon = Ui.findView(convertView, io.particle.android.sdk.devicesetup.R.id.wifi_security_indicator_icon);
                Drawable whiteLock = Ui.getTintedDrawable(getContext(), io.particle.android.sdk.devicesetup.R.drawable.lock,
                        android.R.color.white);
            ...
            Ui.findView(convertView, io.particle.android.sdk.devicesetup.R.id.wifi_security_indicator_icon)
